...
- `cockroach_rf_ladder_safe_20260625_summary_grouped.csv` - grouped throughput and selected latency summary for the safe ladder.
- `cockroach_rf_ladder_safe_20260625_summary_metrics_grouped.csv` - compact grouped metric summary for the safe ladder.
